...
<spring:url value="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css" var="FA" />
		...
		<div class="container">
			...
			<table class="table table-reflow" id="grid">
				<thead>
						 	...
						 	<thead id="showstdInactive"></thead>
