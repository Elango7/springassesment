...
<br>
 ...
 <div class="col-sm-5 "></div>
  ...
  <button id="loginSt" class="btn btn-success">Login</button>
...
<center>
 ...
 <div class="col-sm-1 "></div>
    ...
    <div class="col-sm-4"> <input class="form-control" type="text" id="regName" placeholder="Name" required></div>
   <div class="col-sm-4 "></div>
  </div>
  <br>
 <div class="row"> 
 <div class="col-sm-1 "></div>
    ...
    <div class="col-sm-4"> <input class="form-control" id="regmail" type="text" placeholder="Mail id" required></div>
   <div class="col-sm-4 "></div>
  </div>
  <br>
  <div class="row"> 
 <div class="col-sm-1 "></div>
    ...
    <div class="col-sm-4"> <input class="form-control" id="regPass" type="password" id="firstPass" placeholder="Password" required></div>
   <div class="col-sm-4 "></div>
  </div>
  <br>
...
<select class="selectpicker" id="roledrop" id="regRole" onchange="changeFunc();" title="Choose Role" required> 
 ...
 <div class="col-sm-1 "></div>
    ...
    <div class="col-sm-4"> <input class="form-control" id="actCode" type="password" id="firstPass" placeholder="Activation Code" ></div>
   <div class="col-sm-4 "></div>
  </div>
  <br>
...
<select class="selectpicker"  id="regDept" id="studdrop" required>
  ...
  <br>
    ...
    <div class="row"> <div class="col-sm-1 "></div>	
  <button  id="regUser"   class="btn btn-success">Register</button>
